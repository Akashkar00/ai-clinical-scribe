...
import { MedicalServices, Science } from '@mui/icons-material';
        ...
        <Container maxWidth="lg">
          <Box sx={{ textAlign: 'center', mb: 4 }}>
            <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'center', mb: 2 }}>
              <MedicalServices sx={{ fontSize: 48, color: 'primary.main', mr: 2 }} />
            ...
            <Typography variant="subtitle1" sx={{ color: 'text.secondary', maxWidth: 600, mx: 'auto' }}>
              Transform medical consultations into structured clinical summaries using advanced AI
            </Typography>
          </Box>
